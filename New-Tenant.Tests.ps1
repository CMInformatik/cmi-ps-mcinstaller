...
Describe "New-Tenant" {
    ...
    Context "When writing configuration" {
        ...
        New-Tenant -ConfigurationFile "Testdrive:\t2.json" -Name "Test" -WebServerBaseUri "https://t2.ch/m/" -ErrorAction Stop
        New-Tenant -ConfigurationFile "Testdrive:\t3.json" -Name "Test" -ConfigureLandingPage -ErrorAction Stop
        New-Tenant -ConfigurationFile "Testdrive:\t4.json" -Name "Test" -ConfigureLandingPage -Title "MyTitle" -ErrorAction Stop
